<nav class="navbar navbar-expand-lg navbar-light fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="#"><img src="./images/logo.jpg" class="img-fluid rounded-circle" alt="鸚仔鋪"></a>
                            ...
                            <li class="nav-item dropend">
                                ...
                                <ul class="dropdown-menu">
                                    <?php while ($pyclass02_Rows = $pyclass02->fetch()) { ?>
                                        <li><a href="#" class="dropdown-item"><em class="fas <?php echo $pyclass02_Rows['fonticon']; ?> fa-fw"></em>
    ...
    <?php while ($pyclass01_Rows = $pyclass01->fetch()) { ?>
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                ?>
                <?php while ($pyclass02_Rows = $pyclass02->fetch()) { ?>
                    <li><a href="index.php?classid=<?php echo $pyclass02_Rows['classid']; ?>" class="dropdown-item">
